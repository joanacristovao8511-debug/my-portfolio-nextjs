    ...
    const siteContent = await prisma.siteContent.upsert({
        ...
        update: {
            ...
            whyItems: [
                ...
                { title: "Perfect testing before launch", description: "Test critical paths, improve performance, document key decisions, and leave the product ready to operate and extend." },
            ],
