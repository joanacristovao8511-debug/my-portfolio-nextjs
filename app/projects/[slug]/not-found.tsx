  ...
  return (
    <main className="min-h-screen bg-[#070b12] px-6 py-20 text-white">
      <div className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-tight">That case study is not published.</h1>
        <p className="mt-4 max-w-md text-sm leading-7 text-slate-400">It may have been unpublished or the link may be outdated.</p>
